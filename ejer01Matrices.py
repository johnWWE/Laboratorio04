...
if filaA == filaB and columnaA ==columnaB:
    ...
    #matrizB     
    for i in range(0,filaA):    #ES implicito si es fila B o A ya que ambos deben ser del mimo orden para sumar y restar
        for j in range(0,columnaA):
...
if filaA == filaB and columnaA ==columnaB:
    ...
    print("las Matrices A y B no se pueden restar porque  el orden es diferente")

#producto
''' Evidentemente para el producto de matrices existen ciertas condiciones mas especificas
que en una suma o resta de matrices, ya lo haremos paso por paso en ele ejercicio 02 de matrices'''
